<div class="app-menu">
    ...
    <div class="logo-box">
        ...
        <a href="index.html" class="logo-light">
            <img src="https://www.shutterstock.com/image-vector/food-products-grocery-store-logo-600w-332013962.jpg"
    ...
    <div class="scrollbar">
        ...
        <div class="user-box text-center">
            <img width="200" src="assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme"
        ...
        <ul class="menu">
            ...
            <li class="menu-title">Administration panel</li>
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="?c=products&m=index" class="menu-link">
                                <span class="menu-text">To list</span>
                            </a>
                        </li>
                    </ul>
                </div>
